...
public class PrbFm2 {
  ...
  public static void main(String[] args) {
    ...
    for (String fm : list) {
      System.out.println(">>> FMo: " + fm);

//      fm = getFormulaCorrected(fm);
//
//      System.out.println("    FMc: " + fm);

      fm = adjustFormula(fm, 1, 0);

      System.out.println("    FMa: " + fm);
...
//    }
  ...
  public static String adjustFormula(String fm, int quitar, int poner) {
    if (quitar == 0 && poner > 0) {
      return fm;
    }
    // Corregir H para igualar cargas a cero
      ...
      // No existe H
        ...
        newArray[l1] = (Math.abs(poner) == 1) ? "H" : "H" + Math.abs(poner);
        array = newArray;
      }
